...
avec des débits de l'ordre de 700 $m^3.s^{-1}$. Le didson a été enlevé de l'eau
lors du deuxième pic de crue le 03/02. 
...
de la saison.
La majorité de ces derniers étaient liés à un problème d'accès au disque dur. 
...
En 2023--2024, une succession de 7 pics de crue de 300 à 500 $m^3.s^{-1}$ a été
observée. La première crue intervient tôt, début novembre avec la plus forte
début janvier à 500 $m^3.s^{-1}$ . Durant cette période, le didson a
pratiquement toujours été bien positionné, en vannes, mais également en volets sur le mois d'octobre. Le didson et son rotateur montrent
des signes de fatigue, avec de nombreux plantages en cours de saison, 
mais sans aucune défaillance importante.  
...
xtafls<-xtable::xtable(tabfls,
    ...
    caption="Fonctionnement (nombre de suivis de 30 minutes) du didson en fonction de l'ouverture de la vanne
        et de la position, $s$= appareil en surface, $f5$= appareil en vanne, $n$ appareil en panne,
...
\begin{figure}[htbp]
  ...
  et bleu (clair et foncé), les catégories qui sont significativement différentes au seuil de 90
  et 99\% des effectifs attendus si la répartition était homogène. En gris
  (valeur centrale), les effectifs attendus sont conformes aux attendus du tableau de contingence.
...
entre 300 \si{\cubic\metre\per\second} et 600 \si{\cubic\metre\per\second}). Ces
pics de crue ont commencé dès novembre. Il n'y a pratiquement pas eu de suivi en
volets. Le suivi du fonctionnement vanne / volet par l'automate a permis au didson d'être pratiquement toujours
bien positionné. La migration s'est effectuée lors des trois premiers
pics de débit avec des effectifs journaliers 
anguilles (Figure \ref{fig_N_interannuel}).
