...
plotdebitturbidite <- function(ylim = 1000, ytop=800, d3ej, d3edj){
  ...
  thisseason_d3edj <- d3ej$enj_date>=datedebut
...
# plot, mais pas les axes 
  ...
  polygon(c(min(d3edj$enj_date[thisseason_d3edj])-1,d3edj$enj_date[thisseason_d3edj],max(d3edj$enj_date[thisseason_d3edj])+1),c(100,pmax(100,d3edj$deb_qtotalj[thisseason_d3edj]),100),col="grey",border=NA)
...
plotdebitturbidite(ylim= 700, ytop= 600)
dev.off()
@
...
\begin{figure}[ht!]
  ...
  (NTU, \protect\dashedrule) pendant la période de migration. 
