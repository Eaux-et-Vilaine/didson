...
\hypersetup{
     ...
     pdftitle={Suivi de la dévalaison de l'anguille argentée en 2023--2024
...
\fancyhead[LO,RE]{\slshape \normalsize Rapport didson 2023-2024}
...
\Large 
Suivi de la dévalaison d'anguilles argentées en 2023-2024 (douzième
...
\bigskip
{ \LARGE en 2023--2024 (12ème année)}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{2024/debits_ajustes2024}
\caption[Débits recalculés 2024]{Débits recalculés en \Sexpr{CY}.
...
2023-2024 (Figure \ref{debitvoletjour}).

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{2024/debitvolet2024}
\caption[Débits volet 2024]{Débits recalculés sur chaque volet après correction
...
(Figure \ref{debits_inst2024}).

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{2024/debits_inst2024}
\caption[Débits sur chaque pertuis de vanne pour l'hiver 2023--2024]{Débits de
chacun des pertuis de vanne pour l'hiver 2023--2024 en
fonction des différents types d'écoulements calculés
sur chaque vanne \citep{briand_note_2015}.}
\label{debits_inst2024}
\end{figure}
...
Les données sont séparées par saison de suivi de 2012-2013 à 2023-2024.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{equation}
  \label{eq_tau}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.4\textwidth]{2024/debitturbidite.png}
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.4\textwidth]{2024/fonctionnementvanne.png}
...
xtafls<-xtable::xtable(tabfls,
    ...
    caption="Fonctionnement (nombre de suivis de 30 minutes) du didson en fonction de l'ouverture de la vanne
        et de la position pour la saison 2023-2024. $s$ = appareil en surface, $f5$ = appareil en vanne, $n$ = appareil en panne,
...
\input{../table/2024/depouillement.tex}
...
\begin{figure}[htbp]
      ...
      \begin{subfigure}{0.4\textwidth}
                \centering
                \includegraphics{2024/tpsboxplot}
                \caption[Temps de dépouillement par fichier de 30
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{2024/mulet}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{2024/mulet2}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/horaires}
...
\input{../table/2024/tabfls.tex}
\input{../table/2024/tabflsall.tex}
...
%       ~
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position10}
                \caption{Octobre}
                \label{position10}
       \end{subfigure}        
       \quad
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position11}
                \caption{Novembre}
                \label{position11}
       \end{subfigure}        
       ~
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position12}
                \caption{Décembre}
                \label{position12}
       \end{subfigure}        
       \quad
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position01}
                \caption{Janvier}
                \label{position01}
       \end{subfigure}        
       ~
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position02}
                \caption{Février}
                \label{position02}
       \end{subfigure}        
       \quad
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position03}
                \caption{Mars}
                \label{position03}
       \end{subfigure}        
        ~
        \begin{subfigure}{0.2\textwidth}
                \centering
                \includegraphics[trim=5mm 10mm 15mm 10mm,clip]{2024/position04}
                \caption{Avril}
                \label{position04}
       \end{subfigure}        
...
\end{itemize}
\end{samepage}
Cette année, les problèmes de fonctionnement du didson existent (15
plantages - 5 liés à des accès au disque dur, les autres venant de problèmes
de communication entre le didson et l'ordinateur) mais ont été réglés rapidement
(en orange , Figure \ref{fig_position}).
Les problèmes d'écriture sont intervenus au début de la période de suivi, avant
les ouvertures du barrage, il n'ont pas eu d'incidence. 
L'automate a permis d'assurer le bon positionnement du didson (position dans la vanne)
et il n'y a eu que 3 plantages de l'automate qui ont été réglés rapidement.
Globalement il y a très peu d'enregistrements sur des périodes où le didson est mal positionné (en marron), quand c'est le cas, il peut s'agir d'écoulement en volets ailleurs sur le barrage alors que la vanne 4
a été fermée. 
Les fichiers non dépouillés en gris correspondent majoritairement aux fichiers
le soir et le matin, et au moment de l'ouverture de vannes (Figure
\ref{fig_horairespb}).\\
...
\begin{figure}[htbp]
        ...
        \begin{subfigure}{0.5\textwidth}
                ...
                2mm,clip]{2024/qualite_distance2023-2024}%trim l b r t
                \hspace*{25mm}\caption{\small 2023-2024 \\
                N=\Sexpr{vvv$nqualite}\\
                Volet et vanne. Année en cours}
                \label{/qualite_distance2023-2024}
       \end{subfigure}%     
        \\
      \begin{subfigure}{0.45\textwidth}
                \centering
                \includegraphics[trim=2mm 2mm 2mm
                2mm,clip]{2024/qualite_distance_volet_all}%trim l b
                % r t
      ...
      \begin{subfigure}{0.45\textwidth}
                ...
                2mm,clip]{2024/qualite_distance_vanne_all}%trim l b r
                % t
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/taille_distance}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{2024/taille_dist_mois_all}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{2024/taille_dist_mois}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{2024/mosaic_taille_mois_all}
...
saisons <- unique(dddp$saison)
saisons <- saisons[order(saisons)]
for (s in 1:length(saisons)){
  saison1 <- saisons[s]
...
Le modèle retenu depuis la saison 2022-2023 est plus complexe que le modèle de
2021-2022.
Il s'écrit $\delta + \tau + k + saison + \delta*\tau*k$. Il retient toutes les
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{2024/aovefficacite}
...
\input{../table/2024/repartition_horaire.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{\dimexpr.8pt+\fboxsep\relax}
%\noindent       
%\fbox{%
...
\input{../table/2024/comportement.tex}
\input{../table/2024/traversee.tex}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{2024/structure_taille}
...
Les sexes ratios calculés en utilisant une limite de 
 ...
 \num{\Sexpr{round(100*vvv$sexe_ratio)}} \% de mâles en \Sexpr{saison}, soit la plus importante proportion de mâles observée jusqu'alors.
...
\citep{briand_suivi_2019}, 8\% en 2019-2020 \citep{briand_suivi_2020}, 24\% en
2020-2021 \citep{briand_suivi_2021},
x\% en 2021-2022 \citep{briand_suivi_2022}
et x\% de mâles en 2022-2023 \citep{briand_suivi_2023}.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/gam_predict}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/horairespb2024.png}
...
\input{../table/2024/tabefficacite_moyenne.tex}


\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/fig_effectif}
...
2022--2023 & {-} & 
\num{\Sexpr{round(as.numeric(final[final$Saison=="2022-2023" & final$type=="$\\sum\\odot\\otimes\\oplus$(?)","$N$"]),0)}} & 100\\
2023--2024 & {-} & 
\num{\Sexpr{round(as.numeric(final[final$Saison=="2023-2024" & final$type=="$\\sum\\odot\\otimes\\oplus$(?)","$N$"]),0)}} & 100\\
 \hline
\end{tabular}
\normalsize
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/N_interannuel}
...
\begin{figure}[htbp]
        ...
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode2_phis_dids_-7.png}
        \caption{
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode4_phi0_didf_5}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode4_phi0_didf_5"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode4_phi0_didf_5"$incl}, 
                $h$=\Sexpr{ppp$"periode4_phi0_didf_5"$prof}, 
                $O_t$=\Sexpr{ppp$"periode4_phi0_didf_5"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode4_phi0_didf_5"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode4_phi0_didf_5"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode4_phi0_didf_5"$minus},
                date= \Sexpr{iconv(ppp$"periode4_phi0_didf_5"$date,"UTF-8")}}
        \label{periode6}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode5_phif_didf_5.png}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode5_phif_didf_5.png"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode5_phif_didf_5.png"$incl}, 
                $h$=\Sexpr{ppp$"periode5_phif_didf_5.png"$prof}, 
                $O_t$=\Sexpr{ppp$"periode5_phif_didf_5.png"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode5_phif_didf_5.png"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode5_phif_didf_5.png"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode5_phif_didf_5.png"$minus},
                date= \Sexpr{iconv(ppp$"periode5_phif_didf_5.png"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode7_phif_didf_-7}
        \caption{
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode8_phi0_didf_-7}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode8_phi0_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode8_phi0_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode8_phi0_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode8_phi0_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode8_phi0_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode8_phi0_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode8_phi0_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode8_phi0_didf_-7"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode9_phis_didf_-7}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode9_phis_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode9_phis_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode9_phis_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode9_phis_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode9_phis_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode9_phis_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode9_phis_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode9_phis_didf_-7"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode10_phif_didf_6}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode10_phif_didf_6"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode10_phif_didf_6"$incl}, 
                $h$=\Sexpr{ppp$"periode10_phif_didf_6"$prof}, 
                $O_t$=\Sexpr{ppp$"periode10_phif_didf_6"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode10_phif_didf_6"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode10_phif_didf_6"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode10_phif_didf_6"$minus},
                date= \Sexpr{iconv(ppp$"periode10_phif_didf_6"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode11_phis_didf_6}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode11_phis_didf_6"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode11_phis_didf_6"$incl}, 
                $h$=\Sexpr{ppp$"periode11_phis_didf_6"$prof}, 
                $O_t$=\Sexpr{ppp$"periode11_phis_didf_6"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode11_phis_didf_6"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode11_phis_didf_6"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode11_phis_didf_6"$minus},
                date= \Sexpr{iconv(ppp$"periode11_phis_didf_6"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\subsection{Tableaux}
\onecolumn
\input{../table/2024/aovefficacite.tex}
\newpage{}
\input{../table/2024/tabfinal.tex}
\newpage
\input{../table/2024/table_effectif_mois.tex}
\newpage
\input{../table/2024/tableau_modele_miss.tex}
\normalsize
\begin{landscape}
\begin{figure}
    \includegraphics[width=0.8\linewidth,keepaspectratio]{2024/fig_effectif_pb}
\caption[Effectif]{Effectifs journaliers estimés sur l'ensemble du barrage.
				En turquoise $(N)\odot$ 
				\textcolor{turquoise_EV}{\rule[-0.5mm]{1mm}{3mm}} = effectifs mesurés, 
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]{2024/nombre_taille_distance}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]{2024/efficacite}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]{2024/Ncor}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{2024/taille_distance_vannefond}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{2024/taille_distance_volet}
  \caption[Taille des anguilles vanne]{Taille des anguilles en fonction de la
