...
<<horaires, echo=FALSE, eval=FALSE,results=hide>>=
...
save(vvv,file=str_c(datawdy,"vvv.Rdata"))
@
<<horairespb, echo=FALSE, eval=FALSE,results=hide>>=
...
<<comportement, echo=FALSE,eval=FALSE,results=hide>>= 
...
\label{parpoids}
<<biomasse, echo=FALSE, eval=FALSE, results=hide>>=
...
<<nombre, echo=FALSE, eval=FALSE, results=hide>>=
