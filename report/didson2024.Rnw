...
<<database, echo=FALSE, eval=TRUE,results=hide >>=
require("safer")
require("getPass")
...
@
% METTRE EVAL TRUE / FALSE POUR CALCULER/ACCELERER 
<<d3ej, echo=FALSE, eval=TRUE,results=hide >>=
...
<< d3ejperiodes, echo = FALSE, eval = TRUE, results = hide   >>=
###########################################
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2024/horairespb}
