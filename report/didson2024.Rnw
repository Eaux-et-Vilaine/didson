...
Pour l'ensemble de la période de suivi depuis 2012 $\sum_{saison}N_{obs}$ cet
effectif correspond à \num{\Sexpr{round(vvv$Nprim04all)}} anguilles
argentées. Il y a plus de lectures d'anguilles disponibles dans la base, mais
