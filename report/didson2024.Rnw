...
(Nprim04all <- sum(colSums(ddde[,c("drr_eelplus","drr_eelminus")],na.rm=TRUE))) # 22479
(Nprim04allCY <- sum(colSums(ddde[ddde$dsf_season==saison,c("drr_eelplus","drr_eelminus")],na.rm=TRUE))) # 1581
...
AIC(g9) # delta NS
summary(g10 <- mgcv::gam(N~dsf_season+s(ndays, k=5)+s(deb_qtotalj)+s(enj_turb)+cumflow + s(delta_7d),dat=D7j[D7j$N>0,],family=Gamma(link="log")))
AIC(g10) 
...
toto <- latex(final,
    ...
    longtable = TRUE,
    n.rgroup=c(7, 8, 7, 6, 6, 6, 6, 6, 7, 6, 6),
...
Pour ces jours, un modèle GAM a été utilisé pour extrapoler 
 ...
 \num{\Sexpr{round(100*summary(bestg)$dev.expl,2)}} \% de la déviance. La
...
La saison \Sexpr{saison} se caractérise par des débits de crue moyens avec 
...
\begin{figure}[htbp]
        ...
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode2_phif_didf_4.png}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode2_phif_didf_4"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode2_phif_didf_4"$incl}, 
                $h$=\Sexpr{ppp$"periode2_phif_didf_4"$prof}, 
                $O_t$=\Sexpr{ppp$"periode2_phif_didf_4"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode2_phif_didf_4"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode2_phif_didf_4"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode2_phif_didf_4"$minus},
                date= \Sexpr{iconv(ppp$"periode2_phif_didf_4"$date,"UTF-8")}
                }
                \label{periode4}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode3_phis_didf_4}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode3_phis_didf_4"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode3_phis_didf_4"$incl}, 
                $h$=\Sexpr{ppp$"periode3_phis_didf_4"$prof}, 
                $O_t$=\Sexpr{ppp$"periode3_phis_didf_4"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode3_phis_didf_4"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode3_phis_didf_4"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode3_phis_didf_4"$minus},
                date= \Sexpr{iconv(ppp$"periode3_phis_didf_4"$date,"UTF-8")}}
        \label{periode6}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode5_phif_dids_-7}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode5_phif_dids_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode5_phif_dids_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode5_phif_dids_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode5_phif_dids_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode5_phif_dids_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode5_phif_dids_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode5_phif_dids_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode5_phif_dids_-7"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode6_phis_dids_-7}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode6_phis_dids_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode6_phis_dids_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode6_phis_dids_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode6_phis_dids_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode6_phis_dids_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode6_phis_dids_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode6_phis_dids_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode6_phis_dids_-7"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode8_phi0_didf_5}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode8_phi0_didf_5"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode8_phi0_didf_5"$incl}, 
                $h$=\Sexpr{ppp$"periode8_phi0_didf_5"$prof}, 
                $O_t$=\Sexpr{ppp$"periode8_phi0_didf_5"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode8_phi0_didf_5"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode8_phi0_didf_5"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode8_phi0_didf_5"$minus},
                date= \Sexpr{iconv(ppp$"periode8_phi0_didf_5"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode9_phif_didf_5}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode9_phif_didf_5"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode9_phif_didf_5"$incl}, 
                $h$=\Sexpr{ppp$"periode9_phif_didf_5"$prof}, 
                $O_t$=\Sexpr{ppp$"periode9_phif_didf_5"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode9_phif_didf_5"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode9_phif_didf_5"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode9_phif_didf_5"$minus},
                date= \Sexpr{iconv(ppp$"periode9_phif_didf_5"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode10_phis_didf_5}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode10_phis_didf_5"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode10_phis_didf_5"$incl}, 
                $h$=\Sexpr{ppp$"periode10_phis_didf_5"$prof}, 
                $O_t$=\Sexpr{ppp$"periode10_phis_didf_5"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode10_phis_didf_5"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode10_phis_didf_5"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode10_phis_didf_5"$minus},
                date= \Sexpr{iconv(ppp$"periode10_phis_didf_5"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode11_phis_didf_-7}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode11_phis_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode11_phis_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode11_phis_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode11_phis_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode11_phis_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode11_phis_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode11_phis_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode11_phis_didf_-7"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode12_phi0_didf_-7}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode12_phi0_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode12_phi0_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode12_phi0_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode12_phi0_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode12_phi0_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode12_phi0_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode12_phi0_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode12_phi0_didf_-7"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2024/periode14_phif_didf_14}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode14_phif_didf_14"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode14_phif_didf_14"$incl}, 
                $h$=\Sexpr{ppp$"periode14_phif_didf_14"$prof}, 
                $O_t$=\Sexpr{ppp$"periode14_phif_didf_14"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode14_phif_didf_14"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode14_phif_didf_14"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode14_phif_didf_14"$minus},
                date= \Sexpr{iconv(ppp$"periode14_phif_didf_14"$date,"UTF-8")}               
               }
                \label{periode11}
\end{figure}
\clearpage
