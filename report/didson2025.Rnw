...
didson (Figures \ref{debitturbidite} et \ref{fonctionnementvanne}). Au total,
\SI{300}{\cubic\metre\per\second}) entre début novembre et mi-avril.
Les turbidités montent au-delà de 50 NTU au cours de seconde crue
mi-décembre (Figure \ref{debitturbidite}). Le paramètre turbidité n'est pour
le moment plus enregistré dans SIVA depuis janvier 2024.
...
\num{\Sexpr{round(mean(vvv$number.missingday.all$N))}} journées sans aucun
enregistrement, du fait de problèmes d'acquisition ou d'écriture disque (Figure
\ref{fig_horairespb}). Pour la saison \Sexpr{saison}, ce nombre s'établit à \num{\Sexpr{vvv$number.missingday}}
journées manquantes.
Pour toutes les journées manquantes sur la période de suivi, un modèle GAM a été
utilisé pour extrapoler les effectifs en migration à partir des valeurs des jours proches ($\oplus$).
Le modèle GAM pose des problèmes d'extrapolation pour les périodes sans données,
souvent en début et fin de saison. Pour palier ce problème, les prédictions ont
été encadrées par le maximum observé sur le mois et la saison, avec une
extrapolation à partir des données des autres saisons lorsqu'aucune information
n'était disponible sur un mois donné. Ce modèle utilise une tendance saisonnière
non linéaire, le débit à 7 jours, le débit total, la turbidité  
Le modèle incluant une tendance saisonnière à une bien meilleure puissance
prédictive, mais perturbe l'interprétation de l'effet des autres variables
(débit ...). Une modélisation particulière pourrait être utilisée pour analyser
l'effet des variables environnementales sur la migration ce qui n'est pas
l'objet ici - notre objectif est une interpolation des valeurs manquantes.
L'inclusion de la saison 2024-2025 avec des débits exceptionnels enlève l'effet
de la variable de cumul de débit.  Le modèle explique
\num{\Sexpr{round(100*summary(bestg)$dev.expl,2)}} \% de la déviance.
  La migration correspondant à ces journées
 manquantes est estimée à N = \num{\Sexpr{vvv$N.oplus}} anguilles argentées (Figure \ref{gam_predict}).
 
 %=====================================================================
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{2025/gam_predict}
...
La saison \Sexpr{saison} se caractérise par une succession de pic de crue forts
entre 300 \si{\cubic\metre\per\second} et 650 \si{\cubic\metre\per\second}). Ces
pics de crue ont commencé dès novembre. Il n'y a pratiquement pas eu de suivi en
volet. Le suivi du fonctionnement vanne / volet par l'automate a permis au
didson d'être pratiquement toujours bien positionné. La migration s'est effectuée 
lors des trois premiers pics de débit avec des effectifs journaliers maximums à
plus de 4000 anguilles (Figure \ref{fig_effectif}).
Ces conditions de suivi en vanne n'ont pas trop affecté la qualité des
détections qui sont en moyenne bien supérieures (Figure \ref{qualite_distance})
...
est directement liée à la modification des ouvertures en vannes décrite plus
haut (3.1 Migration).
...
\begin{figure}[htbp]
        ...
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2025/periode2_phif_didf_5.png}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode2_phif_didf_5"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode2_phif_didf_5"$incl}, 
                $h$=\Sexpr{ppp$"periode2_phif_didf_5"$prof}, 
                $O_t$=\Sexpr{ppp$"periode2_phif_didf_5"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode2_phif_didf_5"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode2_phif_didf_5"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode2_phif_didf_5"$minus},
                date= \Sexpr{iconv(ppp$"periode2_phif_didf_5"$date,"UTF-8")}
                }
                \label{periode2}
\end{figure}
...
\begin{figure}[htbp]
        ...
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip,
                width=0.5\textwidth]{2025/periode3_phif_didf_-7.png} \caption{
                $\Phi$=\Sexpr{ppp$"periode3_phif_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode3_phif_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode3_phif_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode3_phif_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode3_phif_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode3_phif_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode3_phif_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode3_phif_didf_-7"$date,"UTF-8")}
                }
                \label{periode3}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2025/periode4_phi0_didf_-7.png}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode4_phi0_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode4_phi0_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode4_phi0_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode4_phi0_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode4_phi0_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode4_phi0_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode4_phi0_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode4_phi0_didf_-7"$date,"UTF-8")}}
        \label{periode6}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2025/periode5_phis_didf_-7.png}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode5_phis_didf_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode5_phis_didf_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode5_phis_didf_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode5_phis_didf_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode5_phis_didf_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode5_phis_didf_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode5_phis_didf_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode5_phis_didf_-7"$date,"UTF-8")}               
               }
                \label{periode5}
\end{figure}
...
\begin{figure}[htbp]
        \centering
        \includegraphics[trim=35mm 40mm 25mm
                25mm,clip, width=0.5\textwidth]{2025/periode1_phis_dids_-7.png}
        \caption{
                $\Phi$=\Sexpr{ppp$"periode1_phis_dids_-7"$Phi}, 
                $\beta$=\Sexpr{ppp$"periode1_phis_dids_-7"$incl}, 
                $h$=\Sexpr{ppp$"periode1_phis_dids_-7"$prof}, 
                $O_t$=\Sexpr{ppp$"periode1_phis_dids_-7"$N}, 
                $O_t\circ$=\Sexpr{ppp$"periode1_phis_dids_-7"$Nsuivis},
                $N'_{4o}+$=\Sexpr{ppp$"periode1_phis_dids_-7"$plus}, 
                $N'_{4o}-$=\Sexpr{ppp$"periode1_phis_dids_-7"$minus},
                date= \Sexpr{iconv(ppp$"periode1_phis_dids_-7"$date,"UTF-8")}               
               }
                \label{periode6}
\end{figure}
