...
obj<-ls(all=TRUE)
obj<-obj[!obj%in%c("passworddistant","passwordlocal","userdistant","hostdistant")]
...
datawd<-"C:/workspace/pdata/didson/rapport/data/" 
datawdy<-str_c(datawd,CY,"/")
imgwd<-"C:/workspace/pdata/didson/rapport/image/"
imgwdy<-str_c(imgwd,CY,"/")
tabwdy<-str_c("C:/workspace/pdata/didson/rapport/table/",CY,"/")
