...
UPDATE did.t_didsonfiles_dsf SET dsf_mois =EXTRACT(month FROM dsf_timeinit); --92067 -- Insertion des données des tables temporaires 
...
dsft_date,dsft_path,dsft_filename
 FROM 
t_didsonfiletemp_dsft;--1323 # 2014 902 2015 951 2016 1421 2017 477 2018 (+34+4+38(jour) 2018) 848 2019 690 2020 985 2021 811 2022
...
psf_latitude_unit,psf_latitude4,psf_latitude3,psf_latitude2,psf_latitude1,psf_date,psf_time,
psf_aspect,psf_ldr,psf_dr_cm,psf_l_cm,psf_theta,psf_radius_m,psf_dir,psf_frame,psf_total,psf_file
 FROM t_poissonsfiletemp_psf;--3429 --1972 -- 2303 --4744 --2031 --1314 (+44+4+87(jour) 2018) 1742 2019 1432 2020 2044 2021 1942 2022
...
JOIN t_didsonreadresult_drr drr ON drr_filename=dsf_filename;--1322 --2455 -- 3518 --4940 -5660 --6195 --6234--7082 -- 7774 -- 8759 --9570
...
WHERE dsf_season='2021-2022'
AND countdrr>1
; --128 2015 4 2016 8 2017 44 2018 0 2019 0 2020 0 2021 0 2022
...
ORDER BY drr_id; --319  -- 12 2016-2017 --5 2017-2018 --6 2018-2019 --5 2019-2020 --17 2020-2021 13 2021-2022
*/
...
(
	...
	FROM   t_didsonfiles_dsf  dsf 	JOIN  t_didsonread_dsr dsr ON dsr_dsf_id=dsf_id
					JOIN t_didsonreadresult_drr drr ON drr_filename=dsf_filename
					WHERE dsf_season='2021-2022')sub
	WHERE count=1)
) uqr	
...
UPDATE t_didsonreadresult_drr SET drr_csotminthreshold_db=0 WHERE drr_csotminthreshold_db IS NULL AND
	...
	JOIN t_didsonreadresult_drr ON drr_dsf_id=dsf_id 
	WHERE dsf_season='2021-2022'
	); --98 --3 -- 67 --37 (2016) --36 (2017) --26 3(2018) -- 8 2 2020 0 2021 29 2022
...
WHERE dsr_csotdb IS NULL and
 dsr_id in (
	...
	WHERE dsf_season='2021-2022'
	); --2019 ---317 2020 804 2021 138 2022 7
...
UPDATE t_didsonread_dsr SET dsr_csotdb=0 WHERE dsr_csotdb IS NULL and
 dsr_id in (
	SELECT dsr_id FROM t_didsonfiles_dsf 
	JOIN t_didsonread_dsr ON dsr_dsf_id=dsf_id 
	WHERE dsf_season='2021-2022' AND dsr_complete
	);

; --122 --4 (2016) --19 (2017)--30 (2018) --1(2018) 371 2019 801 + 0 2020 138 2021 7 2022
...
AND dsf_season='2021-2022'
ORDER BY dsf_id; --2 (2016) 3 (2017) 21 (2018) 0 (2019) 0 (2020) 0 (2021) 0 (2022)
...
;--200 --20 -- 36 --2+1 rows 2016 -- 3 2017 --21 2018 (+1 2018) 0 + 0 2019 0 2020 0 2022
...
UPDATE t_didsonreadresult_drr SET drr_dsr_id=dsr_id FROM dbr
WHERE dbr.drr_id=t_didsonreadresult_drr.drr_id ;--0--0--0 (2017)--0 (2018) 
...
AND dsf_season='2021-2022';--0 --0 2016 --0 2017 --0 2018 --0 2020 --0 2021
...
SELECT * FROM did.t_didsonreadresult_drr WHERE drr_dsr_id in (
  SELECT drr_dsr_id FROM (
    SELECT count(drr_dsr_id),drr_dsr_id FROM did.t_didsonread_dsr
    				...
    				WHERE count>1)
            AND drr_dsf_id in (SELECT dsf_id FROM t_didsonfiles_dsf WHERE dsf_season='2021-2022')				
...
(SELECT dsr_id FROM t_didsonfiles_dsf JOIN t_didsonread_dsr ON dsr_dsf_id=dsf_id WHERE dsf_season='2021-2022'); 
--4200 --3110 (2016) 1780 (2017) 2161 2018 3366 2019 2402 2020 3594 2021 4201 2022
...
--1767 (2017) -- 2110 2018 --3364 (2019) --2402 (2020) -- 3597 (2021) -- 4021 (2022)
...
UPDATE t_didsonread_dsr SET dsr_csotismin=TRUE WHERE dsr_id in
 (SELECT dsr_id FROM t_didsonread_dsr JOIN 
	...
	AND dsr_id in (SELECT dsr_id FROM t_didsonfiles_dsf JOIN t_didsonread_dsr ON dsr_dsf_id=dsf_id WHERE dsf_season='2021-2022')
	) sub 
	ON (sub.dsr_csotdb,sub.dsr_dsf_id)=(t_didsonread_dsr.dsr_csotdb,t_didsonread_dsr.dsr_dsf_id));
--329 --475 --378 --19 (2016) --6 (2017) --25 2018 --1 2019 --0 2020  --0 2021 0--2022
...
UPDATE t_poissonfile_psf SET psf_species='2038' WHERE psf_species=''; -- 2023 (2017) --1203 (2018) (+41+4 2018) --1737 2019 --1430 + 3 2020 1937 2022
...
SELECT dsf_distancestart,drr_windowstart_m,dsf_incl,psf_tilt FROM did.t_didsonfiles_dsf  dsf 	JOIN  did.t_didsonread_dsr dsr ON dsr_dsf_id=dsf_id
		...
		AND drr_windowstart_m!=dsf_distancestart; --exactement inverse... 44 lignes 0lignes 2014 0 lignes 2015 0 lignes 2016 0 lignes 2017 0 lignes 2018 0 lignes 2019 0 2020 0 2021 0 2022
/*
...
SELECT psf_id, dsf_timeinit, date(dsf_timeinit),psf_date, psf_time FROM did.t_didsonfiles_dsf  dsf 	JOIN  did.t_didsonread_dsr dsr ON dsr_dsf_id=dsf_id
		...
		--0 2019 0 2020 0 2021 109 2022 (pb arrondi de dates)
...
SELECT psf_id,dsf_timeinit,dsf_timeend,dsf_filename,psf_date||' '||psf_time drr_timestamp, drr_filename,drr_path,psf_drr_id FROM did.t_didsonfiles_dsf  dsf 	
		...
		ORDER BY dsf_filename; -- 0 (après correction) 2020  --0 2021 --0 2022
...
--0 2017 --0 2018  --0 2019 2=>0 (2020) 0 2021 -- 2 (2022)
